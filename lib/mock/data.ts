...
export const TRAINERS: Trainer[] = [
  {
    ...
    tagline: "MAD FITNEZ instructor",
    bio: "Katherine brings intensity and energy to every session. Her MAD FITNEZ classes are high-octane cardio and strength.",
    photo_url: "https://api.dicebear.com/7.x/initials/svg?seed=KP&scale=110",
    is_active: true,
    sort_order: 1,
  },
  {
    id: "trainer-2",
    name: "Master Daniel Cho",
    tagline: "Taekwondo head instructor",
    bio: "Master Cho brings 20+ years of martial arts expertise. He teaches kids and adults with patience and discipline.",
    photo_url: "https://api.dicebear.com/7.x/initials/svg?seed=DC&scale=110",
    is_active: true,
    sort_order: 2,
  },
  {
    ...
    bio: "Mike specializes in powerlifting and free-weight training. He knows the Iron Club inside and out.",
    photo_url: "https://api.dicebear.com/7.x/initials/svg?seed=MR&scale=110",
    is_active: true,
    sort_order: 3,
  },
  {
    ...
    bio: "Sara's Functional Fit classes combine movement patterns, metabolic conditioning, and real-world strength.",
    photo_url: "https://api.dicebear.com/7.x/initials/svg?seed=SB&scale=110",
    is_active: true,
    sort_order: 4,
  },
];
